	...
	class pe extends W {
		constructor(t, e) {
			super(t, e),
				...
				(this._menu =
					K.next(this._element, le)[0] || K.prev(this._element, le)[0] || K.findOne(le, this._parent)),
		...
		static dataApiKeydownHandler(t) {
			...
			const n = this.matches(re)
					? this
					: K.prev(this, re)[0] || K.next(this, re)[0] || K.findOne(re, t.delegateTarget.parentNode),
		...
		_setListeners() {
			...
			for (const e of t)
				if ('click' === e)
					...
					const t =
							e === Ii ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
